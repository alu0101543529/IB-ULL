...
/**
 * @brief Comprueba si el anio de una fecha es bisiesto.
...
/**
 * @brief Comprueba si un anio bisiesto.
...
/**
 * @brief Calcula la cantidad de dias de un mes del anio.
 * @param[in] mes: Mes
 * @param[in] anio: Año.
...
/// Para almacenar los últimos días de cada mes (si no es anio bisiesto)
...
Fecha StringAFecha(const std::string& fecha) {
  ...
  int contador{0}; /// Para saber si vamos por el día, el mes o el anio
